...
export class CountryFlagService {
  constructor() {}
   ...
   gelFlag(name) {
    ...
    function checkAdult(flag) {
      return flag.name === name;
    }
    
     let flagsFind =  flags.find(checkAdult)
...
const flags = [
  ...
  },
  {
    ...
    alpha3: "BOL",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/d/de/Flag_of_Bolivia_%28state%29.svg",
  ...
  },
  {
    ...
    alpha3: "IOT",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/6/6e/Flag_of_the_British_Indian_Ocean_Territory.svg",
  ...
  },
  {
    ...
    alpha3: "GLP",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/0/04/Flag_of_Guadeloupe_%28local%29.svg",
    name: "Guadeloupe",
    license: "Public domain"
  },
  {
  ...
  },
  {
    ...
    alpha3: "HMD",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/f/fa/Flag_of_Antarctica.svg",
  ...
  },
  {
    ...
    alpha3: "MTQ",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/5/52/Flag_of_Martinique.svg",
    name: "Martinique",
    license: "Public domain"
  },
  {
  ...
  },
  {
    ...
    alpha3: "NCL",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/2/23/Flag_of_New_Caledonia.svg",
    name: "New Caledonia",
    license: "Public domain"
  },
  {
  ...
  },
  {
    ...
    alpha3: "SPM",
    file_url:
      "//upload.wikimedia.org/wikipedia/commons/7/74/Flag_of_Saint-Pierre_and_Miquelon.svg",
